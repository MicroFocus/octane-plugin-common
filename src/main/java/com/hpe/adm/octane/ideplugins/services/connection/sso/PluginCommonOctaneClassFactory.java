...
/**
 * Class factory for the sso http client
 */
public class PluginCommonOctaneClassFactory implements OctaneClassFactory {

    private static Proxy httpProxy;
    private static PluginCommonOctaneClassFactory instance = new PluginCommonOctaneClassFactory();

    private PluginCommonOctaneClassFactory(){}
    public static PluginCommonOctaneClassFactory getInstance(){ return instance; }
    ...
    public static void setHttpClientProxy(Proxy httpProxy){
        PluginCommonOctaneClassFactory.httpProxy = httpProxy;
    }

    @Override
    public OctaneHttpClient getOctaneHttpClient(String urlDomain) {
        return new SsoLoginGoogleHttpClient(urlDomain);
    }
