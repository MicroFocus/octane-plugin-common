...
public class OctaneVersionService {
    ...
    private static String getVersionString(ConnectionSettings connectionSettings) {
        try {
            ...
            logger.error("Failed to retrieve Core Software Delivery Platform server version");
            throw new ServiceRuntimeException("Failed to retrieve Core Software Delivery Platform server version", e);
        }
    }
